...
#define	XRAM_SIZE 0x900 //2304 Byte
#endif

//-----------------------------------------------------
//  A96T428 Special Function Register Definitions
//----------------------------------------------------- 0x80
...
#endif
#if A96T418_MODE==0
#define WDTCK_1           ((INT8U)0x00) 	
#define WDTCK_2           ((INT8U)0x02) 	
#define WDTCK_4           ((INT8U)0x04) 	
#define WDTCK_8           ((INT8U)0x06) 	
#define WDTCK_16           ((INT8U)0x08) 	
#define WDTCK_32           ((INT8U)0x0A) 	
#define WDTCK_64           ((INT8U)0x0C) 	/*!< WDTCR[3:1]
                                        Control WDT Operation
                                        0 : BIT overflow for WDT clock
                                        1 : BIT overflow/8 for WDT clock
                                        */
