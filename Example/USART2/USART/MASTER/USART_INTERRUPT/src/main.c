...
void Display_project(void)
{
	...
	printf("\n\ra96T428 USART1 USART MASTER INTERRUPT TEST!!");
}
...
void Main( void )
{
	...
	Port_SetAlterFunctionpin(PORT1, PIN7, 0x3);
		/* Set Alternative function  SCK1(P15)  */
	Port_SetAlterFunctionpin(PORT1, PIN5, 0x3);
	
	USART2_USART_Initial(SPI2_MASTER_MODE, 100000, SPI2_CPOL_LOW, SPI2_TX_RX_MODE, USART2_DATA_8BIT);
