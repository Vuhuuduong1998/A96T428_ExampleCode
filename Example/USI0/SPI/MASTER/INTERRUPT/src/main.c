...
void Main( void )
{
	...
	if(test_mode==0)
	{
		USI_SPI_Initial(SPI_CH0, SPI_MASTER_MODE, 100000, SPI_LSB, SPI_CPOL_LOW, SPI_CPHA_1EDGE, SPI_TX_RX_MODE, SPI_SS_HW_ENABLE);
		printf("\n\r SPI_SS_HW_ENABLE mode ");
	}
	else if(test_mode==1)
	{
		USI_SPI_Initial(SPI_CH0, SPI_MASTER_MODE, 100000, SPI_LSB, SPI_CPOL_LOW, SPI_CPHA_1EDGE, SPI_TX_RX_MODE, SPI_SS_HW_DISABLE);
