...
//		WDTCR |= 0x20; //WDTCL, Clear WDT 
	...
	printf("\n\r Self Address  = %02X ", (unsigned int)I2C_DEVICE_ADDRESS);
	printf("\n\r Self Address2 = %02X ", (unsigned int)I2C_DEVICE_ADDRESS2);
	...
	{     
		...
		{          
			...
			{
				targetAddr=I2C_SELF_ADDR;
				targetTXlength=0; targetRXlength=I2C_MAX_BUFFER_SIZE;				
				USI_I2C_MasterTransferData(I2C_CH0, I2C_SELF_ADDR, 0, 0, read_data, I2C_MAX_BUFFER_SIZE);				
			}
			else if(c=='R') //master RX only 
			{
				targetAddr=I2C_SELF_ADDR2;
				targetTXlength=0; targetRXlength=I2C_MAX_BUFFER_SIZE;				
				USI_I2C_MasterTransferData(I2C_CH0, I2C_SELF_ADDR2, 0, 0, read_data, I2C_MAX_BUFFER_SIZE);				
			}
			else if(c=='t') //master TX only 
			{
				targetAddr=I2C_SELF_ADDR;
				targetTXlength=I2C_MAX_BUFFER_SIZE; targetRXlength=0;				
				USI_I2C_MasterTransferData(I2C_CH0, I2C_SELF_ADDR, write_data, I2C_MAX_BUFFER_SIZE, 0, 0);				
			}
			else if(c=='T') //master TX only 
			{
				targetAddr=I2C_SELF_ADDR2;
				targetTXlength=I2C_MAX_BUFFER_SIZE; targetRXlength=0;				
				USI_I2C_MasterTransferData(I2C_CH0, I2C_SELF_ADDR2, write_data, I2C_MAX_BUFFER_SIZE, 0, 0);				
			}
			else if(c=='x') //repeated mode , master TX & RX 
			{
				targetAddr=I2C_SELF_ADDR;
				targetTXlength=I2C_MAX_BUFFER_SIZE; targetRXlength=I2C_MAX_BUFFER_SIZE;				
				USI_I2C_MasterTransferData(I2C_CH0, I2C_SELF_ADDR, write_data, I2C_MAX_BUFFER_SIZE, read_data, I2C_MAX_BUFFER_SIZE);
			}
			else if(c=='X') //repeated mode , master TX & RX 
			{
				targetAddr=I2C_SELF_ADDR2;
				targetTXlength=I2C_MAX_BUFFER_SIZE; targetRXlength=I2C_MAX_BUFFER_SIZE;				
				USI_I2C_MasterTransferData(I2C_CH0, I2C_SELF_ADDR2, write_data, I2C_MAX_BUFFER_SIZE, read_data, I2C_MAX_BUFFER_SIZE);
			}
