...
void Display_project(void)
{
	...
	printf("\n\ra96T428 USART1 USART SLAVE INTERRUPT TEST!!");
}

void Main( void )
{
	volatile uint8_t i;
	extern uint8_t spi2_readNum0;
	...
	USART1_USART_Initial(SPI2_SLAVE_MODE, 100000, SPI2_CPOL_LOW, SPI2_TX_RX_MODE, USART1_DATA_8BIT);
