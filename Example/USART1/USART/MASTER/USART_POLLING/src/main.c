...
void Display_project(void)
{
	...
	printf("\n\ra96T428 USART1 USART MASTER POLLING TEST!!");
}
...
void Main( void )
{
	...
	USART1_USART_Initial(SPI2_MASTER_MODE, 100000, SPI2_CPOL_LOW, SPI2_TX_RX_MODE, USART1_DATA_8BIT);
   ...
   NOP_10us_Delay(10000);    // 100msec delay
	...
	while (1)
	{
		...
		USART1_USART_SendReceiveDataWithPolling(write_data, read_data, 4);
